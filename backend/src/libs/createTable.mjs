...
export const createTable = async () => {
    ...
    try {
        const table = await Promise.all([
            ...
            connectdb.query(`create table pagos(idPago serial PRIMARY KEY, monto decimal, fecha date, banco text, referencia decimal, nombre text, cedula varchar(8), tipodepagoid int, personaid int)`),
